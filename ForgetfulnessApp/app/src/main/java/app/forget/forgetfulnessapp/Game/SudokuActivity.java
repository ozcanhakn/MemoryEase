...
public class SudokuActivity extends AppCompatActivity {
    ...
    private void checkCurrentLocale() {
        ...
        if (currentLanguage == null) {
            ...
            if (((Locale) locale).getLanguage().equals("no") || locale.getLanguage().equals("nb") || locale.getLanguage().equals("nn")) {
    ...
    public void onStartNewGameButtonClicked(View view) {
        Intent intent = new Intent(SudokuActivity.this,GameDifficultyActivity.class);
        startActivity(intent);
    }

    public void onAddNewBoardButtonClicked(View view) {
        Intent intent = new Intent(SudokuActivity.this, NewBoardActivity.class);
        startActivity(intent);
    }

    public void onShowInstructionsButtonClicked(View view) {
        Intent intent = new Intent(SudokuActivity.this,InstructionsActivity.class);
        startActivity(intent);
    }
